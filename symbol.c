...
Scope        * currentScope;           /* ÔñÝ÷ïõóá åìâÝëåéá              */
unsigned int   quadNext;               /* Áñéèìüò åðüìåíçò ôåôñÜäáò      */
unsigned int   tempNumber;             /* Áñßèìçóç ôùí temporaries       */

static unsigned int   hashTableSize;   /* ÌÝãåèïò ðßíáêá êáôáêåñìáôéóìïý */
static SymbolEntry ** hashTable;       /* Ðßíáêáò êáôáêåñìáôéóìïý        */
...
/* ---------------------------------------------------------------------
   ------- Õëïðïßçóç âïçèçôéêþí óõíáñôÞóåùí ôïõ ðßíáêá óõìâüëùí --------
   --------------------------------------------------------------------- */
...
/* ---------------------------------------------------------------------
   ------ Õëïðïßçóç ôùí óõíáñôÞóåùí ÷åéñéóìïý ôïõ ðßíáêá óõìâüëùí ------
   --------------------------------------------------------------------- */
...
void initSymbolTable (unsigned int size)
{
    ...
    /* ÄéÜöïñåò áñ÷éêïðïéÞóåéò */
    
    currentScope = NULL;
    quadNext     = 1;
    tempNumber   = 1;
    
    /* Áñ÷éêïðïßçóç ôïõ ðßíáêá êáôáêåñìáôéóìïý */
...
void destroySymbolTable ()
{
    ...
    /* ÊáôáóôñïöÞ ôïõ ðßíáêá êáôáêåñìáôéóìïý */
...
static SymbolEntry * newEntry (const char * name)
{
    ...
    /* Áñ÷éêïðïßçóç üëùí åêôüò: entryType êáé u */
...
void destroyEntry (SymbolEntry * e)
{
    ...
    switch (e->entryType) {
        ...
        case ENTRY_PARAMETER:
            /* Ïé ðáñÜìåôñïé êáôáóôñÝöïíôáé ìáæß ìå ôç óõíÜñôçóç */
            return;
